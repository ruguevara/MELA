...
function notOperaFix() {
	...
	if (isIE && document.styleSheets && document.styleSheets[0]) {
		document.styleSheets[0].addRule('img', 'behavior: url(ui/big-black/iepngfix.htc)');
		document.styleSheets[0].addRule('div', 'behavior: url(ui/big-black/iepngfix.htc)');
		document.styleSheets[0].addRule('.slide', 'behavior: url(ui/big-black/iepngfix.htc)');
	}
}
